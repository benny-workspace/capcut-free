...
function loadVideo(media) {
  ...
  el.muted = true;
  el.preload = "auto";
  const usable = PLAYABLE_VCODECS.includes(media.vcodec || "") || !media.proxyPath ? media.path : media.proxyPath;
...
async function runFramePipeExport(project, settings, onProgress, cancel) {
  ...
  const videoMediaIds = /* @__PURE__ */ new Set();
  for (const track of project.tracks) {
...
function Inspector() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inspector", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inspector-body", children: [
      ...
      clip.kind !== "audio" && clip.kind !== "adjust" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "insp-section", children: "Transform" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Slider, { label: "X", value: t.x, min: -0.5, max: 0.5, step: 5e-3, onCommitStart: beginInteraction, onChange: (v) => patchTransform({ x: v }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Slider, { label: "Y", value: t.y, min: -0.5, max: 0.5, step: 5e-3, onCommitStart: beginInteraction, onChange: (v) => patchTransform({ y: v }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Slider, { label: "Scale", value: t.scale, min: 0.05, max: 3, step: 0.01, onCommitStart: beginInteraction, onChange: (v) => patchTransform({ scale: v }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Slider, { label: "Rotation", value: t.rotation, min: -180, max: 180, step: 1, onCommitStart: beginInteraction, onChange: (v) => patchTransform({ rotation: v }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Slider, { label: "Opacity", value: t.opacity, min: 0, max: 1, step: 0.01, onCommitStart: beginInteraction, onChange: (v) => patchTransform({ opacity: v }) })
      ] }),
...
async function boot() {
  ...
  if (hasApi && new URLSearchParams(location.search).has("smoke")) {
    const { runSmoke } = await __vitePreload(async () => {
      const { runSmoke: runSmoke2 } = await import("./smoke-Bnyyv0Zh.js");
